        ...
        <Card className="border-0 shadow-2xl">
          <CardContent className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-gray-300 text-[#1877F2]" />
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link to="/register" className="text-[#1877F2] font-medium hover:underline">
                Sign up for free
              </Link>
            </p>
            ...
            <div className="mt-4 text-center text-xs text-gray-500">
              <p>Demo accounts:</p>
              <p>Admin: admin@virtualitlabs.com / admin123</p>
              <p>Student: demo@example.com / demo123</p>
            </div>
          </CardContent>
        </Card>
      </div>
